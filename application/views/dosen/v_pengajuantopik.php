                ...
                <tbody>
                    ...
                    foreach($list_TopikPropose as $row){ ?>
                      <tr>
                        ...
                        <td><?= $row['status'] ?></td>
                        <td>
                          <center><button data-link="<?php echo base_url('/Data/accept/'.$row['id_judul']) ?>" type="button" id="do-confirm"class="btn btn-sm btn-success" name="tombol_accept"><i class="fas fa-check"></i> Accept</button></center>
