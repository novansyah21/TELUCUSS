       ...
       <div class="container-fluid">
            ...
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    foreach($list_pengajuanpembimbing as $row){ ?>
                      <tr>
                        <td><?= $no ?></td>
                        <td><?= $row['nim'] ?></td>
                        ...
                        <td><?= $row['status'] ?></td>
                        <td>
                          <center><button data-link="<?php echo base_url('/Data/acceptbimbing/'.$row['id_judul']) ?>" type="button" id="do-confirm"class="btn btn-sm btn-success" name="tombol_accept"><i class="fas fa-check"></i> Accept</button></center>
