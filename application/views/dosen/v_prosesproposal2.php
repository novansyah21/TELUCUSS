      ...
      <div id="content-wrapper">
       <div class="container-fluid">
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <a href="" class="btn btn-secondary active">Proposal Pembimbing </a>
            </div><br><br>
                ...
                <tbody>
                    <?php
                    $no = 1;
                    foreach($list_judulproposalta2 as $row){ ?>
                      <tr>
                        <td><?= $no ?></td>
                        <td><?= $row['nim'] ?></td>
                        ...
                        <td>
                          ...
                          <br>
                          <center><a href='<?= base_url('/Data/proposalupdate2/'.$row['id_judul']) ?>' class='btn btn-sm btn-primary'>Acc Proposal</i></a></center>
                          <br>
                          <center><a href='<?= base_url('/Data/rejectproposal2/'.$row['id_judul']) ?>' class='btn btn-sm btn-primary'>Reject</i></a></center>
                        </td>
                      </tr>
                    <?php $no++; } ?>
                </tbody>
