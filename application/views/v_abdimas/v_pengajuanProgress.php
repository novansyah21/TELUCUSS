      ...
      <div id="content-wrapper">
       <div class="container-fluid">
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <a href="<?= base_url('/Abdimas/pengajuanProgressAccepted') ?>" class="btn btn-secondary">Pengajuan sudah disetujui</a>
                <a href="<?= base_url('/Abdimas/pengajuanProgressRejected') ?>" class="btn btn-secondary">Pengajuan ditolak</a>
            </div><br><br>
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    foreach($list_abdimasPropose as $row){ ?>
                      <tr>
                        <td><?= $no ?></td>
