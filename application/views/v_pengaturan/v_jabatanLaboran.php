       ...
       <div class="container-fluid">
          <div class="mb-3">
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <a href="" class="btn btn-secondary active">Laboran</a>
          ...
          <form action="<?= base_url('Pengaturan/setLaboran') ?>" method="post">
            <input type="hidden" name="nip_lama" value="<?= $dataLaboran['nip'] ?>">
            <div class="form-group">
                <label for="nama_awal">Nama Lengkap (beserta gelar)</label>
                <input type="text" name="nama_awal" class="form-control col-md-5 " value="<?= $dataLaboran['nama_awal'] ?>">
            </div>
            <div class="form-group">
                <label for="nama_awal">NIP</label>
                <input type="text" name="nip" class="form-control col-md-5 " value="<?= $dataLaboran['nip'] ?>">
            </div>
