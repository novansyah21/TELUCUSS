      ...
      <div id="content-wrapper">
       <div class="container-fluid">
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <a href="<?= base_url('/Penelitian_kk/pengajuanDitolak') ?>" class="btn btn-secondary">Pengajuan ditolak</a>
            </div><br><br>
                          ...
                          <center>
                            ...
                            <?php 
                              if (!empty($row['proposal'])) { ?>
                                <button data-link="<?= base_url('/Penelitian_kk/berjalan/'.$row['id_penelitian']) ?>" type="button" id="do-progress" class="btn btn-sm btn-success">Nyatakan Berjalan</button>
                                <?php
                              }else { ?>
